...
kdebindings="smokegen \
	...
	pykde4 \
	kross-interpreters"
# C# compiler  <http://www.mono-project.com>
# Mono or the .NET framework
# Required to compile the C# bindings
#qyoto kimono"
...
mpkg-install qt4 soprano akonadi sip speech-dispatcher libassuan PyQt libraw -y
...
for i in $MODLIST ; do
	...
	( cd $i
		if 
		 [[ "$i" != "kde-workspace" ]] \
		  && mkpkg -si -bb 1 -bv $KDE_VERSION -pod ${DIRKA} \
		  || mkpkg -si -bb 2 -bv 4.11.4 -pod ${DIRKA} \
		 ;
	        then
